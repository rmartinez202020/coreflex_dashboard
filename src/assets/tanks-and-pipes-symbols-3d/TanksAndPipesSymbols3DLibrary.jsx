...
const images = import.meta.glob(
  "/src/assets/tanks-and-pipes-symbols-3d/*.{png,jpg,jpeg,svg,gif}",
  { eager: true }
);
...
export default function TanksAndPipesSymbols3DLibrary({ onSelect, onDragStart }) {
  return (
    <div className="cf-library-container" onMouseDown={(e) => e.stopPropagation()}>
      <h4 className="cf-library-title">Tanks & Pipes Symbols 3D</h4>
