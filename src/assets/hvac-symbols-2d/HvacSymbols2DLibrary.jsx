...
const images = import.meta.glob(
  "/src/assets/hvac-symbols-2d/*.{png,jpg,jpeg,svg,gif}",
  { eager: true }
);
...
export default function HvacSymbols2DLibrary({ onSelect, onDragStart }) {
  return (
    <div className="cf-library-container" onMouseDown={(e) => e.stopPropagation()}>
      <h4 className="cf-library-title">HVAC Symbols 2D</h4>
