...
const images = import.meta.glob(
  "/src/assets/manufacturing-symbols-3d/*.{png,jpg,jpeg,svg,gif}",
  { eager: true }
);
...
export default function ManufacturingSymbols3DLibrary({ onSelect, onDragStart }) {
  return (
    <div className="cf-library-container" onMouseDown={(e) => e.stopPropagation()}>
      <h4 className="cf-library-title">Manufacturing Symbols 3D</h4>
