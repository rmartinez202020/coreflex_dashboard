              ...
              <table className="w-full table-auto text-[12px]">
                <thead>
                  ...
                  <tr className="bg-blue-200">
                    ...
                    <th className="text-left font-bold text-slate-900 px-1.5 py-1 border-b border-blue-300 w-[110px] border-r border-blue-300">
                      last seen
                    </th>

                    {TP4000_TE_COLS.map((c) => (
                      <th
                        key={c.key}
                    ...
                    <th className="text-right font-bold text-slate-900 px-2 py-1 border-b border-blue-300 w-[110px]">
                      Action
                    </th>
                  </tr>
                  ...
                  <tr className="bg-white text-[11px]">
                    ...
                    <th className="px-1.5 py-1 border-b border-slate-200 border-r border-slate-200" />
                ...
                <tbody>
                  {loading && rows.length === 0 ? (
                    <tr>
                      <td
                        colSpan={4 + TP4000_TE_COLS.length + 1}
                    ...
                    rows.map((r, idx) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="px-1.5 py-1 border-b border-slate-100 text-slate-800 truncate border-r border-slate-200">
