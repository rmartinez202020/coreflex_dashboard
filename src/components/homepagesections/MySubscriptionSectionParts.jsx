...
export function LoadingDataModal({ open }) {
  ...
  return (
    <div className="fixed inset-0 z-[10000] flex items-center justify-center bg-slate-900/45 px-4 backdrop-blur-[2px]">
      <div className="w-full max-w-sm rounded-2xl border border-emerald-200 bg-white p-6 text-center shadow-2xl">
        <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-emerald-50">
          <div className="h-9 w-9 rounded-full border-4 border-slate-200 border-t-emerald-600 animate-spin" />
        </div>
        ...
        <div className="mt-1 text-[13px] leading-relaxed text-slate-600">
          Preparing your subscription details...
        </div>
