              ...
              <table className="w-full table-fixed text-[12px]">
                <thead>
                  <tr className="bg-blue-200">
                    <th className="px-1 py-[3px] w-[95px] text-left font-bold">
                      DEVICE ID
                    </th>
                    <th className="px-1 py-[3px] w-[95px] text-left font-bold">
                      Date
                    </th>
                    <th className="px-1 py-[3px] w-[80px] text-left font-bold">
                      Status
                    </th>
                    <th className="px-1 py-[3px] w-[100px] text-left font-bold border-r border-blue-300">
                      Last Seen
                    </th>
                    {[
                      "DI-1","DI-2","DI-3","DI-4",
                      ...
                      <th key={k} className="px-1 py-1 w-[46px] text-center font-bold">
                        {k}
                      </th>
                    ))}
                  </tr>
                  ...
                  {!rows.length ? (
                    ...
                    rows.map((r, i) => (
                      <tr key={i} className={i % 2 ? "bg-slate-50" : "bg-white"}>
                        ...
                        <td
                          className="px-1 py-[3px] truncate"
                          title={r.addedAt || ""}
                        >
                          {formatDateMMDDYYYY_hmma(r.addedAt)}
                        </td>

                        <td className="px-1 py-[3px] capitalize">
                          {r.status}
                        </td>

                        <td
                          className="px-1 py-[3px] truncate border-r border-slate-200"
                          title={r.lastSeen || ""}
                        >
