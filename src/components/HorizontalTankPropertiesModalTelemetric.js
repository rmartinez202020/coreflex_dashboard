// src/components/HorizontalTankPropertiesModalTelemetric.js
...
// ✅ Same helper used across your modals: handles ai1 / AI1 / ai_1 / AI_1 / ai-1 / AI-1
 ...
 *
 * Mirrors your other *PropertiesModalTelemetric hooks.
 */
export default function useHorizontalTankPropertiesModalTelemetric({
  open,
  bindModel,
  bindDeviceId,
  bindField,
