// src/components/VerticalTankSettingsModal.jsx
...
export default function VerticalTankSettingsModal({ open = true, tank, onSave, onClose }) {
  ...
  // (you mentioned "density" is your Math field)
  ...
  const [materialColor, setMaterialColor] = useState(
    ensureAlpha(props.materialColor || "#00ff00")
  );
  ...
  useEffect(() => {
    ...
    setMaterialColor(ensureAlpha(p.materialColor || "#00ff00"));
    ...
    >
      ...
      >
        ...
        <div
          ...
          title="Drag to move"
        >
          <div>Vertical Tank Properties</div>
          <button
            data-no-drag="true"
            onClick={onClose}
            style={{
            ...
            >
              ...
              <div style={{ display: "flex", justifyContent: "flex-end", gap: 10, marginTop: 4 }}>
                ...
                <button
                  disabled={!canApply}
                  onClick={() => {
                    // ✅ IMPORTANT: DraggableVerticalTank reads:
                    // - name/title from props.name
                    // - formula from props.density
                    // - capacity from props.maxCapacity
                    // - color from props.materialColor
                    const nextProps = {
                      ...(tank?.properties || {}),
