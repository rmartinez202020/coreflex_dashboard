...
export default function GraphicDisplayPanel({
  ...
  // ✅ Totalizer pill style (matches frame / header)
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ✅ BLACK DIVIDER LINE (same as frame) */}
        <div
          style={{
            height: 1,
            background: "#cfcfcf", // matches the outer frame border color
            width: "100%",
          }}
        />
        ...
        >
          ...
          {/* ✅ TOTALIZER on the right side of bottom header */}
          {totalizerEnabled ? (
            <div style={totalizerPillStyle} title={totalTitle}>
              ...
              <span style={{ marginLeft: 6, fontFamily: "monospace" }}>
                {Number.isFinite(totalizerValue)
                  ? `${Number(totalizerValue).toFixed(2)} ${totalizerTotalUnit || ""}`
                  : "--"}
              </span>
            </div>
          ) : null}
        ...
        {/* existing light divider between header + plot area */}
            ...
            {hover ? (
              <>
                ...
                >
                  ...
                  <div>
                    Y:{" "}
                    <span style={{ color: "#0b3b18" }}>{Number.isFinite(hover.y) ? Number(hover.y).toFixed(2) : "--"}</span>
                  </div>
                </div>
              </>
            ) : null}
